...
## 1. Why we need goodtools to visualize annotation 

Using UCSC we can visualize the locations of our prospective sites, SnpEff vcf outputs, and bed files.

![DAB2 Example](Galaxy_tutorial_pictures/DAB2_p1.png) 
![DAB2 Example](Galaxy_tutorial_pictures/DAB2_p2.png)
...
![](Galaxy_tutorial_pictures/output_1.png)

![](Galaxy_tutorial_pictures/output_2.png)


![](Galaxy_tutorial_pictures/DAB2_variant.png)

DAB2 Amino Acid Substitutions
![](Galaxy_tutorial_pictures/Dab2_AA_sub.png)

Note that just like in the picture of DAB2 on UCSC we found the same amino acid changes! 

DAB2 Allele read counts
![](Galaxy_tutorial_pictures/dab2_ARC.png)
...
![](Galaxy_tutorial_pictures/UCSC_home_2.png)

### b. Loading Custom Tracks on UCSC
Click the custom custom track button to add our files. 

![](Galaxy_tutorial_pictures/custom_track_button.png)
...
![](Galaxy_tutorial_pictures/bam_link_2.png)
...
![](Galaxy_tutorial_pictures/manage_custom_new.png)
...
```
![](Galaxy_tutorial_pictures/manage_custom_2.png)
...
![](Galaxy_tutorial_pictures/manage_custom_3_new.png)
...
![](Galaxy_tutorial_pictures/UCSC_custom_new.png)
...
![](Galaxy_tutorial_pictures/UCSC_custom_new_2.png)
...
![](Galaxy_tutorial_pictures/GREM1_snp_AF.png)
...
![](Galaxy_tutorial_pictures/SnpEff_workflow.png) 
...
![](Galaxy_tutorial_pictures/galaxy_layout.png) 
...
![](Galaxy_tutorial_pictures/import_history.png) 
...
![](Galaxy_tutorial_pictures/import_done.png) 
...
![](Galaxy_tutorial_pictures/isec_search.png) 
...
![](Galaxy_tutorial_pictures/isec_options.png) 
...
![](Galaxy_tutorial_pictures/isec_workflow_big.png)

![](Galaxy_tutorial_pictures/isec_workflow_1.png)
...
11248940
```
![](Galaxy_tutorial_pictures/isec_workflow_3.png)
The isec output should look like this! 
![](Galaxy_tutorial_pictures/isec_output.png) 
Another way to visualize bcftools isec is to see it almost a venn diagram 
![](Galaxy_tutorial_pictures/venny.png) 
![](Galaxy_tutorial_pictures/venny_result.png) 
...
![](Galaxy_tutorial_pictures/view_workflow.png) 
...
![](Galaxy_tutorial_pictures/view_options.png) 

#### Bcftools view -Restrict by region
![](Galaxy_tutorial_pictures/view_region_options_new.png) 


#### Bcftools view -Restrict by allele frequency
![](Galaxy_tutorial_pictures/view_allele_options_new.png) 


### d. SNPeff eff
SnpEff will allow us to identify the specific changes that are caused due to variants.

![](Galaxy_tutorial_pictures/snpeff_search.png) 
...
![](Galaxy_tutorial_pictures/snpeff_parameters.png)
...
![](Galaxy_tutorial_pictures/download_vcf.png)
...
#### Simple
![](Galaxy_tutorial_pictures/simple_database.png)

#### Detailed
![](Galaxy_tutorial_pictures/detailed_database.png)
